...
export default function IntegrationView() {
  ...
  const [apiKey, setApiKey] = useState('sk_live_4f8b2c9d1e6a3b7f5c2d8e9a1b4c6d7e');
  const [webhookUrl, setWebhookUrl] = useState('https://api.zarafashion.com/webhooks/tryon');
