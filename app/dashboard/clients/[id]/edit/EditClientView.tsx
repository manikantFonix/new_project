...
const clientData: Record<string, any> = {
  '1001': {
    ...
    webhookUrl: 'https://api.fashionbrandx.com/webhook',
    apiEnabled: true,
    currentBalance: 74000,
    apiKey: 'fbx_live_a8f3k2m9p1q4r7s2t6v8w3x5y9z1',
  ...
  '1002': {
    ...
    webhookUrl: 'https://api.luxuryapparel.com/webhook',
    apiEnabled: true,
    currentBalance: 105500,
    apiKey: 'lac_live_b9g4l3n0q2r5s8t7u9v4w6x2y0z3',
  ...
  '1003': {
    ...
    apiKey: 'usi_live_c0h5m4o1r3s6t9u8v0w5x3y1z4',
  ...
  '1004': {
    ...
    storageDuration: '48 hours',
    webhookUrl: 'https://api.elitefashion.com/webhook',
    apiEnabled: true,
    currentBalance: 108000,
    apiKey: 'efh_live_d1i6n5p2s4t7u0v9w6x4y2z5',
  ...
  '1005': {
    ...
    apiKey: 'mwl_live_e2j7o6q3t5u8v1w0x7y5z3',
  ...
  '1006': {
    ...
    maxConcurrentJobs: 8,
    storageDuration: '48 hours',
    webhookUrl: 'https://api.trendyboutique.com/webhook',
    apiEnabled: false,
    currentBalance: 4000,
    apiKey: 'tbt_live_f3k8p7r4u6v9w2x1y8z6',
  ...
  '1007': {
    ...
    maxConcurrentJobs: 10,
    storageDuration: '48 hours',
    webhookUrl: 'https://api.classiccouture.com/webhook',
    apiEnabled: true,
    currentBalance: 56000,
    apiKey: 'cct_live_g4l9q8s5v7w0x3y2z7',
  ...
  '1008': {
    ...
    maxConcurrentJobs: 6,
    storageDuration: '24 hours',
    webhookUrl: 'https://api.streetfashion.com/webhook',
    apiEnabled: true,
    currentBalance: 27500,
    apiKey: 'sfc_live_h5m0r9t6w8x1y4z3',
  ...
  '1009': {
    ...
    maxConcurrentJobs: 5,
    storageDuration: '24 hours',
    webhookUrl: 'https://api.vintagethreads.com/webhook',
    apiEnabled: false,
    currentBalance: 0,
    apiKey: 'vth_live_i6n1s0u7v9w2x5y6z4',
  ...
  '1010': {
    ...
    apiKey: 'cwi_live_j7o2t1v8w0x3y7z5',
  ...
  '1011': {
    ...
    maxConcurrentJobs: 12,
    storageDuration: '72 hours',
    webhookUrl: 'https://api.premiumattire.com/webhook',
    apiEnabled: true,
    currentBalance: 92000,
    apiKey: 'pat_live_k8p3u2w9x1y5z8',
  ...
  '1012': {
    ...
    maxConcurrentJobs: 8,
    storageDuration: '48 hours',
    webhookUrl: 'https://api.casualcomfort.com/webhook',
    apiEnabled: true,
    currentBalance: 38000,
    apiKey: 'ccl_live_l9q4v3x0y2z6',
